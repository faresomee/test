                ...
                <div class="table-responsive ps">
                  <table class="table tablesorter " id="page1">
                    <thead class=" text-primary">
                      <tr><th>Product Code (id)</th><th>Image</th><th>Name</th><th>Price</th><th>
	<a class=" btn btn-primary" href="addproduct.php">Add New</a><a class=' btn btn-success' href='deleteproduct.php?product_id=$product_id&action=delete'>Delete</a></th></tr></thead>
                    <tbody>
                      <?php 
                        ...
                        {
                        echo "<tr><td>$product_id</td><td><img src='../product_images/$image' style='width:50px; height:50px; border:groove #000'></td><td>$product_name</td>
                        <td>$price</td>
                        <td>
